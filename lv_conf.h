...
#define LV_VDB_SIZE         (LV_HOR_RES_MAX * LV_VER_RES_MAX) /*Size of VDB in pixel count*/
#define LV_VDB_ADR          0xC0200000            /*Place VDB to a specific address (e.g. in external RAM) (0: allocate automatically  into RAM)*/

/* Use two Virtual Display buffers (VDB) parallelize rendering and flushing (optional)
 * The flushing should use DMA to write the frame buffer in the background*/
#define LV_VDB_DOUBLE       1       /*1: Enable the use of 2 VDBs*/
#define LV_VDB2_ADR         0xC0377800       /*Place VDB2 to a specific address (e.g. in external RAM) (0: allocate automatically into RAM)*/
 ...
 */
#define LV_FONT_CUSTOM_DECLARE	LV_FONT_DECLARE(calistoda_84)
