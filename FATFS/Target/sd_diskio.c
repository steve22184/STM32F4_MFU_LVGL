...
static int USER_CheckStatusWithTimeout(uint32_t timeout);
...
DRESULT USER_read(BYTE lun, BYTE *buff, DWORD sector, UINT count)
{
  ...
  */
  ...
  if (USER_CheckStatusWithTimeout(SD_TIMEOUT) < 0)
  {
    return res;
  }
